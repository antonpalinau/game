...
console.log(__WEBPACK_IMPORTED_MODULE_8__draggable__["a" /* draggable */]);
...
//window.actions.mortalkombat.autoplay = true;
...
function openTaskTranslate() {
    ...
    console.log(randomVocabularProp);
...
function openTaskMisspelling() {
    ...
    console.log(randomMisspellingProp);
...
function openTaskCapitals() {
    ...
    console.log(randomCapitalsProp);
...
class Game {
    ...
    reset() {
        ...
        //this.monster.x = 0;
        //this.monster.y = 0;
        //this.monster.width = 116;
        //this.monster.height = 80;
...
class Monster extends __WEBPACK_IMPORTED_MODULE_2__Drawable__["a" /* Drawable */] {
    ...
    updateDestroy() {
        ...
        if (this.destroyFrame === this.particles.length) {
            game.deadMonsters++;
            console.log(game.deadMonsters);
            console.log(game.hero.playername);
            setTimeout(() => {
                this.context.clearRect(0, 0, this.canvas.width, this.canvas.height);
            }, 2000);
            setTimeout(() => {
